...
- Syntax:
    ...
    <img src="images/template-literals.png" width="60%"/>


- Example:
    <img src="images/template-literals-ex.png" max-width="60%" />
...
- After destructuring - img
    <img src="images/object-literals.png" max-width="60%" />
...
- Example: 
    <img src="images/for-of.png" max-width="60%" />
...
- Example:
    <img src="images/spread-operator.png" max-width="60%" />
...
- Syntax:
    ...
    ```
- Example: 
    <img src="images/rest-operator.png" max-width="60%" />


## Arrow Functions
- An arrow function expression is a compact alternative to a traditional function expression, but is limited and can't be used in all situations.
- Example: 
    <img src="images/arrow-function.png" max-width="60%" />
...
If you pass a value then that value will be consoled .
...
To fetch data from an api or …. Asynchronization
setTimeout
